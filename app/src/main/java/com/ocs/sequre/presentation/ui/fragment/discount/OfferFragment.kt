...
import kotlinx.android.synthetic.main.fragment_discount_card_offer.view.*
...
class OfferFragment : BaseFragment(R.string.offer_details) {
    ...
    override fun onViewBound(view: View) {
        ...
        view.service_network.setOnClickListener {
            findNavController().navigate(R.id.action_offerFragment_to_serviceProviderFragment)
        }
    }
